            ...
            <div :style="odgovor.odgovor_stranka_logo_uri != null ? 'height: 40px': ''">
                ...
                <div  v-if="!this.isTouchDevice()" style="display: inline-block; float: right;">
                    <Report
                        ...
                        tip="odgovor"
                        :id="this.vprasanje_id + '_' + index"
                        :pot="'ankete/' + this.anketa_id + '#' + this.vprasanje_id + '_' + index"
                    />
                    <CopyLink
                        :class="{'side-button': !this.isTouchDevice()}"
                        :path="'ankete/' + this.anketa_id + '#' + this.vprasanje_id + '_' + index"
...
export default {
    name: 'Odgovor',
    props: ['odgovor', 'anketa_id', 'index', "vprasanje_id"],
    components: {
        Report,
        CopyLink
    }
