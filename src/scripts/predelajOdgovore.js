        ...
        if (podatek === 'procent_izvajalec' || (podatek === 'st_mandatov_izvajalec' && vprasanje.odgovori[i].st_mandatov_izvajalec)) {
            ...
            if (vprasanje.odgovori[i].tip === 'O' && vprasanje.odgovori[i].udelezba_tip === 'NBG') {
                ...
                podatki.labels.push(
                    ...
                    this.vrniOdgovor(vprasanje.odgovori[i].odgovor_std ?? vprasanje.odgovori[i].opredeljen_tip ?? vprasanje.odgovori[i].tip, false, 1) ?? // ali ima primat odgovor ali tip lahko, da bo treba pri nekaterih odgovorih potrebno spremeniti
            ...
            if (vprasanje.odgovori[i].tip === 'O' && vprasanje.odgovori[i].udelezba_tip === 'NBG') {
                ...
                podatki.backgroundColor.push(
                    ...
                    this.vrniStdBarvo(
                        ...
                        vprasanje.odgovori[i].opredeljen_tip ??
